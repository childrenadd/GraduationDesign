...
package org.springboot.demo.upload.util.color.colorthief;

import org.springboot.demo.upload.util.color.colorthief.MMCQ.CMap;
import org.springboot.demo.upload.util.color.colorthief.MMCQ.VBox;
...
public class ColorThiefMain {
/*
    public static void main(String[] args) throws IOException {
        ColorThiefMain test = new ColorThiefMain();

        test.test("E:\\draw\\src\\main\\resources\\draw\\bg\\bg1.png");

       *//* test.test("examples/img/haibao.png");
     ...
     */
    public String[] test(String pathname) throws IOException {
        //System.out.println("Analyzing image " + pathname + "...");

        sb.append("<h1>Image: &quot;").append(pathname).append("&quot</h1>");
        sb.append("<p><img src=\"").append(pathname).append("\" style=\"max-width:50%\"></p>");
        ...
        String[] res = printVBox(dominantColor);
     ...
     *            the vbox
     */
    private String[] printVBox(VBox vbox) {
        ...
        String[] result = rgbString.substring(4,rgbString.length()-1).split(",");
